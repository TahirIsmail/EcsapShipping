...
<style>
    /* 22122020 */
.notification-table th, .notification-table td, .notification-table a{
    ...
    <div class="white-box">
        <div class="">
            ...
            <?= GridView::widget([
                ...
                'tableOptions' => [ //added this on 12222020
                    'class'=>'table table-striped table-bordered notification-table'
                ],
                'columns' => [
