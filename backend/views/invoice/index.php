...
if (isset($Role['customer'])) {
    ...
    ?>
           ...
           <?php if (isset($Role['customer'])) {
                            echo Yii::$app->controller->renderPartial('_invoices_customer', ['dataProvider' => $dataProvider]);
                        } else {
                            echo Yii::$app->controller->renderPartial('_invoices_admin', ['dataProvider' => $dataProvider]);
                        }
            ?>
        </div>
    </div>
