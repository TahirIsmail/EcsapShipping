...
GridView::widget([
    ...
    'columns' => [
        ...
        ['class' => 'yii\grid\ActionColumn',
            'options' => ['class' => 'action-column', 'style' => 'min-width:130px;'],
            'template' => '{usa}{update}{view}',
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    $btn = Html::a("<span class='glyphicon glyphicon-pencil'></span>", [''], [
                        'value' => Yii::$app->urlManager->createUrl('invoice/update?id='.$key),
            ...
            'visibleButtons' => [
                ...
                'view' => Yii::$app->user->can('super_admin'),
            ],
        ],
    ],
]);
