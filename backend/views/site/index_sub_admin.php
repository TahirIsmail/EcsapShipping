                     ...
                     <?php
                      echo GoogleChart::widget(array('visualization' => 'PieChart',
                       'data' => array(
                        ...
                        array('Car on Way    '.$all_vehicle['car_on_way'], (int) $all_vehicle['car_on_way']),
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><span cursor="pointer" status="Picked Up" class="labels label-danger all-status" id="5">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=5&location=&status=Picked Up" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                              <td><a href="<?php Yii::$app->getUrlManager()->getBaseUrl(); ?>/vehicle/index?VehicleSearch[status]=5" target="_blank">View</a></td>
                            </tr>
                           <tr>
                              <td>Shipped </td>
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><span cursor="pointer" location='1' status="Picked Up" class="labels label-danger all-status" id="5">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=5&location=1&status=Picked Up" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                  ...
                  <div class="col-md-6">
                     ...
                     <?php
                      echo GoogleChart::widget(array('visualization' => 'PieChart',
                       'data' => array(
                        array('Task', 'All Statuses'),
                        array('Car on Way    '.$vehicle_location_GA['car_on_way'], (int) $vehicle_location_GA['car_on_way']),
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><span cursor="pointer" location='2' status="Picked Up" class="labels label-danger all-status" id="5">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=5&location=2&status=Picked Up" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                  ...
                  <div class="col-md-6">
                     ...
                     <?php
                      echo GoogleChart::widget(array('visualization' => 'PieChart',
                       'data' => array(
                        array('Task', '2'),
                        array('Car on Way    '.$vehicle_location_NY['car_on_way'], (int) $vehicle_location_NY['car_on_way']),
                     ...
                     <table class="table table-striped table-bordered" style="min-height: 447px;">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><span cursor="pointer" status="Car on way" location="3" class="labels label-danger all-status" id="3">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=3&location=3&status=Car on way" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><span cursor="pointer" location=3 status="Picked Up" class="labels label-danger all-status" id="5">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=5&location=3&status=Picked Up" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                  ...
                  <div class="col-md-6">
                     ...
                     <?php
                      echo GoogleChart::widget(array('visualization' => 'PieChart',
                       'data' => array(
                        array('Task', 'All Statuses'),
                        array('Car on Way    '.$vehicle_location_TX['car_on_way'], (int) $vehicle_location_TX['car_on_way']),
                        ...
                        <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=1&location=4&status=On hand" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><span cursor="pointer" location=4 status="Picked Up" class="labels label-danger all-status" id="5">Report</span></td>
                              <td><a class="btn btn-primary open-pdf" href="/site/statuspdf?id=5&location=4&status=Picked Up" title="Will open the generated PDF file in a new window" target="_blank" data-toggle="tooltip"><i class="status-button fa fa-file-pdf-o"></i> Open as Pdf</a></td>
