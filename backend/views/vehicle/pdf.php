...
<div id="" class="">
  <div class="cond_here">
    ...
    <img src="<?= \yii\helpers\Url::to('@web/uploads/logo.jpg', true)?>" width="224" height="72" alt="GlobalW Logo">
    </div>
    <div class="lefti title center" style="width: 40%;float:left;text-align:center;padding-top:5px;"><h5>AFG Global Shipping<br> 290 NYE AVE, Irvington , NJ 07111<br>
 Tel: 018622377066</h5></div>
...
<td>
        ...
        <tbody><tr><td style="font-size: 12px;"><b>1.</b> Liability-Shipper (customer) must have door-to-door insurance while goods are in warehouse and during transit. AFG GLOBAL SHIPPING will not
