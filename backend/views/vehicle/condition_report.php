    ...
    <div class="cond_here">
      ...
      <div class="col-md-12">
        <div class="cond_logo lefti">
            <img src="<?= \yii\helpers\Url::to('@web/uploads/logo.jpg', true) ?>" width="224" height="72" class="print-logo" alt="GlobalW Logo">
        </div>
...
<?php } ?>
            <div class="papugay">
                <table width="100%">
                    <tbody><tr><td><b>1.</b> Liability-Shipper (customer) must have door-to-door insurance while goods are in warehouse and during transit. AFG GLOBAL SHIPPING will not
            ...
            <div class="sign"><table>
                    <tbody><tr>
                            <td class="leni line_under">&nbsp;
                             <?php // echo ucfirst($model->createdby->username);?>
                            </td>
    ...
    <div class="customer_part">
        <!-- <div class="lefti">
            <img src="../uploads/Logo.png" width="224" height="72" alt="GlobalW Logo">
            </div> -->
        <div class="row">
        <div class="pics">
