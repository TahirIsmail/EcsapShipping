...
<div id="page_border" >
    <?php
        ...
        $vehicle_weight = 0;
        foreach ($all_vehicles_ids as $data) {
...
<?php }?>
    ...
    <div class="bola" style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;margin-right: auto;margin-left: auto;color: #000;text-transform: uppercase;font-family: Arial, Helvetica, sans-serif;">
         <table class="lefti" style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <tbody>
               <tr>
                  <td width="50%" id="lopa" style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;text-transform: uppercase;font-size:16px;"><b><?php if (empty($model->broker_name)) {?>AFG Global MARITIME<?php } else {echo $model->broker_name;}?></b><?php if (!empty($model->oti_number)) {?><p>OTI License #:<?=$model->oti_number;?> </p><?php }?></td>
                  <td width="50%" style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;text-transform: uppercase;font-size:17px;"><b>BILL OF LADING</b></td>
               </tr>
            </tbody>
         </table>
         <!-- sajid -->
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 50%;font-weight:bold;border-top:solid 1px;border-right:solid 1px;width:50%;width:50%;font-weight:bold;">SHIPPER / EXPORTER</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;border-top:solid 1px;font-weight:bold;">BOOKING #</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;border-top:solid 1px;border-left:solid 1px;font-weight:bold;">REFERENCE #</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-right:solid 1px;width:50%;text-transform: uppercase;">
                        <?php echo $customer_detail->company_name . '&nbsp;' . $customer_detail->address_line_1;?><br>
                        <?php echo $customer_detail->state . '&nbsp;' . $customer_detail->city . '&nbsp;' . $customer_detail->zip_code; ?> <br>
                        <?php echo $customer_detail->phone; ?><br>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;">
                       
                        <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;border:none;">
                           <thead>
                              <tr>
                                 <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;"> &nbsp; <?=$model->booking_number;?></td>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;font-weight:bold;">PLACE OF RECEIPT</td>
                              </tr>
                              <tr>
                                 <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 3px;">&nbsp;<?=$model->port_of_loading;?></td>
                              </tr>
                           </tbody>
                        </table>
                        <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
                           <thead>
                              <tr>
                                 <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;font-weight:bold;">PORT OF DISCHARGE:</td>
                              </tr>
                           </thead>
                        </table>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;">
                     
                     <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
                        <thead>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;border-left:solid 1px;"><?=$model->ar_number;?></td>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;font-weight:bold;border-left:solid 1px;">PORT OF LOADING</td>
                           </tr>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 3px;border-left:solid 1px;">&nbsp;<?=$model->port_of_loading;?></td>
                           </tr>
                        </tbody>
                     </table>
                     <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
                        <thead>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;"><?=$model->port_of_discharge;?></td>
                           </tr>
                        </thead>
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 50%;border-top:solid 1px;border-right:solid 1px;width:50%;font-weight:bold;font-weight:bold;">CONSIGNEE</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;border-top:solid 1px;font-weight:bold;font-weight:bold;">PIER</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;border-left:solid 1px;border-top:solid 1px;font-weight:bold;">VESSEL</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-right:solid 1px;width:50%;text-transform: uppercase;">
                     ...
                     if ($model->houstanCustomCoverLetter->consignee) {
                        ...
                        ?>
                                    <br>
                                    <?=$data_consignee->consignee_address_1;?><br>
                                    <?=$data_consignee->city . '&nbsp;' . $data_consignee->state . '&nbsp;' . $data_consignee->country?> <br>
                                    TEL: <?=$data_consignee->phone;?>
                     <?php }}?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;border-right:solid 1px;">
                        
                     <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
                        <thead>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;">&nbsp; <?=$model->terminal;?></td>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;font-weight:bold;">LOADING PIER/TERMINAL</td>
                           </tr>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 3px;">&nbsp;<?=$model->port_of_loading;?></td>
                           </tr>
                  ...
                  <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
                        <thead>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;font-size:13px;padding: 3px;border-top:solid 1px;font-weight:bold;">VOYAGE NO.</td>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 3px;">&nbsp;<?=$model->voyage;?></td>
                           </tr>
                        </tbody>
                     </table>
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 50%;border-top:solid 1px;border-right:solid 1px;font-weight:bold;">NOTIFY</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 50%;border-top:solid 1px;">FOR RELEASE OF CARGO PLEASE CONTACT:</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;border-right:solid 1px;">
                  <?php
                     if ($model->houstanCustomCoverLetter->notify_party) {
                        ...
                        ?>
                                    <br>
                                    <?=$data_consignee->consignee_address_1 . $data_consignee->consignee_address_1;?><br>
                                    <?=$data_consignee->city . '&nbsp;' . $data_consignee->state . '&nbsp;' . $data_consignee->country?> <br>
                                    TEL: <?=$data_consignee->phone;?>
                  <?php }}?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;">
                     ...
                     <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;
                     border-collapse: collapse;
                        width: 100%;">
                        <thead>
                           <tr>
                              <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;background-color: #fff;font-size:13px;padding: 12px;"><b>ETA/</b><?=$model->eta?>, <?=$model->port_of_discharge?></td>
                           </tr>
                        </thead>
                        <tbody>
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;border-right:solid 1px;font-weight:bold;">CONTAINER #</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;border-right:solid 1px;font-weight:bold;">CONTAINER TYPE</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;border-right:solid 1px;font-weight:bold;">SEAL #</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">SPECIAL INSTRUCTIONS</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding:5px;border-right:solid 1px;">
                     <?=$model->container_number;?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;padding:5px;border-right:solid 1px;">
                     &nbsp;                   <?php if ($model->container_type) {echo isset(\common\models\Lookup::$container_type[$model->container_type]) ? \common\models\Lookup::$container_type[$model->container_type] : $model->container_type;}?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px;border-right:solid 1px;">
                     <?=$model->seal_number;?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px;">
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 76%;border-top:solid 1px;font-weight:bold;">SHIPPERS DESCRIPTIONS OF GOODS</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">WEIGHT</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">CUBE</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding:5px">
                  <b><?=count($all_vehicles_ids);?>UNITS USED VEHICLES </b>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;padding:5px">
                  <br>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
                  <b>55 M3</b>
            ...
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">Year</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">Make</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">Model/Color</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">Vin</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">WEIGHT</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;">CUBE</td>
            ...
            <?php
               ...
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding:5px">
                  <?php echo $vehicle_detail->year; ?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;padding:5px">
                  <?php echo $vehicle_detail->make; ?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
                  <?php echo $vehicle_detail->model . '&nbsp;/' . $vehicle_detail->color; ?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
                  <?php echo $vehicle_detail->vin; ?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
                  <?php echo round($vehicle_detail->weight * 0.45359237); ?>kg
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">*** NON HAZ MAT</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">OCEAN FREIGHT PAID </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;border-top:solid 1px;font-weight:bold;">TOTAL WEIGHT KG</td>
               </tr>
            </thead>
            <tbody>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding:5px">
                  <b>*** SEND TELEX RELEASE </b>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 0px;background-color: #fff;text-transform: uppercase;padding:5px">
                  <b>ITN#</b> <?=$model->itn?>
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding: 0px;padding:5px">
                  <?=round($vehicle_weight * 0.45359237)?>
                  </td>
         ...
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <tbody>
               <tr><td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: capitalize;padding:5px">
                  These Comodities, technology or software were exported from the United States in the acordance with the exoirt administrative regulations. Diversion contrary to the U.S. law prohibited.</td>
               </tr>
            </tbody>
         </table>
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;">
            <tbody>
               ...
               <tr><td style="font-size:12px;font-family: Arial, Helvetica, sans-serif;color:#000000b8;background-color: #fff;text-transform: uppercase;padding:3px">
               HEREBY CERTIFY HAVING RECEIVED THE ABOVE DESCRIBED SHIPMENT IN OUTWARDLY GOOD CONDITION FROM THE SHIPPER SHOWN IN SECTION "EXPORTER", FOR FORWARDING TO THE ULTIMATE CONSIGNEE SHOWN IN THE SECTION "CONSIGNEE" ABOVE. IN WITNESS WHEREOF, THE ____________ NONNEGOTIABLE FCR'S HAVE BEEN SIGNED, AND IF ONE (1) IS ACCOMPLISHED BY DELIVERY OF GOODS, ISSUANCE OF A DELIVERY ORDER OR BY SOME OTHER MEANS, THE OTHERS SHALL BE AVOIDED IF REQUIyellow BY THE FREIGHT FORWARDER, ONE (1) ORIGINAL FCR MUST BE SURRENDEyellow, DULY ENDORSED IN EXCHANGE FOR THE GOODS OR DELIVERY ORDER.</td>
               </tr>
            </tbody>
         </table>
         <table style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;border-collapse: collapse;width: 100%;margin-top:30px;">
            <thead>
               <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 20%;font-weight:bold;">AUTHORIZED:</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;border-bottom:solid 1px;">
                  </td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;width: 25%;font-weight:bold;">DATED AT:</td>
                  <td style="font-family: Arial, Helvetica, sans-serif;color:#000000b8;padding: 5px;text-transform: uppercase;font-size:13px;;width: 25%;border-bottom:solid 1px;"><?php // $model->eta ?></td>
               </tr>
            </thead>
         </table>
    </div>
