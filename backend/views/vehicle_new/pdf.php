...
<div id="" class="">
  <div class="cond_here">
    ...
    <img src="<?= \yii\helpers\Url::to('@web/uploads/logo.jpg', true)?>" width="224" height="72" alt="AFG GlobalW Logo">
    </div>
...
<td>
        ...
        <tbody><tr><td style="font-size: 12px;"><b>1.</b> Liability-Shipper (customer) must have door-to-door insurance while goods are in warehouse and during transit. AFG Global will not
